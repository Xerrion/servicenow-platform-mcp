...
# ---------------------------------------------------------------------------
# Helpers (DESCRIBE_NOISE_FIELDS, _ref_value, _bool_value, _int_value,
# _build_slim_field_list, _build_verbose_field_list, _parse_fields_filter)
# now live in ``servicenow_mcp.tools._describe_helpers`` so the unified
# ``describe`` tool can share them. Phase 4 deletes this module; the helper
# module survives.
